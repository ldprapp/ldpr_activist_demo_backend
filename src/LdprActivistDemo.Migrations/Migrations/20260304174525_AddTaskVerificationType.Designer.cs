...
namespace LdprActivistDemo.Migrations.Migrations
{
    ...
    [Migration("20260304174525_AddTaskVerificationType")]
    partial class AddTaskVerificationType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LdprActivistDemo.Persistence.TaskSubmission", b =>
                {
                    ...
                    b.ToTable("task_submissions", null, t =>
                        {
                            t.HasCheckConstraint("ck_task_submissions_decision_status_allowed", "\"DecisionStatus\" IS NULL OR \"DecisionStatus\" IN ('in_progress','approve','rejected')");
                        });
                });
