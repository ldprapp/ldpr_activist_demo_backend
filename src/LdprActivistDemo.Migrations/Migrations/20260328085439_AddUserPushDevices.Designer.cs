...
namespace LdprActivistDemo.Migrations.Migrations
{
    ...
    [Migration("20260328085439_AddUserPushDevices")]
    partial class AddUserPushDevices
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
                    ...
                    b.ToTable("users", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_users_referral_code_range", "\"ReferralCode\" >= 100000 AND \"ReferralCode\" <= 999999");
            ...
            modelBuilder.Entity("LdprActivistDemo.Persistence.UserPushDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("user_push_devices", null, t =>
                        {
                            t.HasCheckConstraint("ck_user_push_devices_platform_allowed", "\"Platform\" IN ('android','ios','web')");
                        });
                });
